      ...
      if (menuChoice === "View All Departments") {
        ...
        db.query("SELECT * FROM roles", (err, res) => {
            ...
            },
            {
              ...
              validate: employeeManagerInput => {
                if (employeeManagerInput) {
                  ...
                  console.log("Please input the employees manager.");
                  return false;
                }
              }
            }
          ...
          .then((answers) => {
            ...
            db.query(`INSERT INTO employee (first_name, last_name, role_id, manager_id) VALUES (?, ?, ?, ?)`, [answers.firstName, answers.lastName, employeeRole.id, answers.employeeManager.id], (err, res) => {
              if (err) throw err;
